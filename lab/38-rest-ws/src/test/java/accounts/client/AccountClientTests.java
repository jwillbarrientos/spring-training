...
public class AccountClientTests {
	...
	public void createAccount() {
		...
		//	TOD0-09: Retrieve the Account you just created from
	...
	public void addAndDeleteBeneficiary() {
		...
		// TOD0-13: Create a new Beneficiary
		// - Remove the @Disabled on this test method.
		...
		// TOD0-14: Retrieve the Beneficiary you just created from the location that was returned
		...
		// TOD0-15: Delete the newly created Beneficiary
		...
		HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
			...
			// TOD0-16: Try to retrieve the newly created Beneficiary again.
