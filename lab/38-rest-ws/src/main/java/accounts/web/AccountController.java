...
public class AccountController {
	 ...
	 */
	// TOD0-02: Review the code that performs the following
	 ...
	 */
	// TOD0-04: Review the code that performs the following
	 ...
	 * response.
	 */
	// TOD0-06: Complete this method. Add annotations to:
	...
	private ResponseEntity<Void> entityWithLocation(Object resourceId) {
		...
		// TOD0-07: Set the 'location' header on a Response to URI of
	 ...
	 */
	// TOD0-10: Complete this method. Add annotations to:
	...
	public ResponseEntity<Void> addBeneficiary(@PathVariable long accountId, @RequestBody String beneficiaryName) {
		...
		// TOD0-11: Create a ResponseEntity containing the location of the newly
		// created beneficiary.
	 ...
	 * given id.
	 */
	// TOD0-12: Complete this method by adding the appropriate annotations to:
	...
	// TOD0-17 (Optional): Add a new exception-handling method
