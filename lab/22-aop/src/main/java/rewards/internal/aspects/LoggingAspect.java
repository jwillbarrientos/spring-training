...
// 	TOD0-02: Use AOP to log a message before
...
public class LoggingAspect {
	...
	// TOD0-03: Write Pointcut Expression
    ...
    // TOD0-07: Use AOP to time update...() methods.
	...
	public Object monitor(ProceedingJoinPoint repositoryMethod) throws Throwable {
		...
		try {
			...
			//  TOD0-08: Add the logic to proceed with the target method invocation.
			//  - Be sure to return the target method's return value to the caller
			//    and delete the line below.

			//return new String("Delete this line after completing TOD0-08");
