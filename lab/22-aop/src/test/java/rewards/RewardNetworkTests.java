...
public class RewardNetworkTests {
	...
	public void testRewardForDining(OutputCapture capture) {
		...
		// TOD0-06: Run this test. It should pass AND you should see TWO lines of
		...
		// TOD0-09: Save all your work, and change the expected matches value above from 2 to 4.
