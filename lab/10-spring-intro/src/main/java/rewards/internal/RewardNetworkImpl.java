 ...
 *
 * TOD0-01: Review the Rewards Application document (Refer to the lab document)
 * TOD0-02: Review project dependencies (Refer to the lab document)
 * TOD0-03: Review Rewards Commons project (Refer to the lab document)
 * TOD0-04: Review RewardNetwork interface and RewardNetworkImpl class below
 * TOD0-05: Review the RewardNetworkImpl configuration logic (Refer to the lab document)
 * TOD0-06: Review sequence diagram (Refer to the lab document)
 */
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
        // TOD0-07: Write code here for rewarding an account according to
        //          the sequence diagram in the lab document
        // TOD0-08: Return the corresponding reward confirmation
