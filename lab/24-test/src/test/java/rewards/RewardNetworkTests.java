 ...
 *
 * TOD0-01: Use Spring TestContext Framework
...
/* TOD0-02: Annotate all 'Stub*Repository' classes with @Repository
...
/* TOD0-03: Assign the 'jdbc' profile to all Jdbc*Repository classes
...
/* TOD0-07: Use "jdbc" and "jndi" as active profiles
...
/* TOD0-08 (Optional): Create an inner static class from TestInfrastructureConfig
