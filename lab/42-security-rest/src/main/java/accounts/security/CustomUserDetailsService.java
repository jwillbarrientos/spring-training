...
//TOD0-13 (Optional): Create custom UserDetailsService
...
//TOD0-14a (Optional): Add authentication based upon the custom UserDetailsService
//- Annotate the class with @Component to make it a Spring manager bean

//TOD0-18b (Optional): Remove the CustomUserDetailsService definition
