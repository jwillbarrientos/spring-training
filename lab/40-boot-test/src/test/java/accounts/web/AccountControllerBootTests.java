...
// TOD0-06: Get yourself familiarized with various testing utility classes
...
// TOD0-07: Replace @ExtendWith(SpringExtension.class) with the following annotation
// - @WebMvcTest(AccountController.class) // includes @ExtendWith(SpringExtension.class)
@WebMvcTest(AccountController.class)
public class AccountControllerBootTests {

	// TOD0-08: Autowire MockMvc bean
    @Autowired
    private MockMvc mockMvc;

	// TOD0-09: Create AccountManager mock bean using @MockBean annotation
    @MockBean
    private AccountManager accountManager;

	// TOD0-10: Write positive test for GET request for an account
	...
	// TOD0-11: Write negative test for GET request for a non-existent account
    ...
    // TOD0-12: Write test for `POST` request for an account
	...
	// TOD0-13 (Optional): Experiment with @MockBean vs @Mock
