...
// TOD0-01: Make this class a Spring Boot test class
// - Add @SpringBootTest annotation with WebEnvironment.RANDOM_PORT

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class AccountClientTests {

	// TOD0-02: Autowire TestRestTemplate bean to a field
	// - Name the field as restTemplate
    @Autowired
    private TestRestTemplate restTemplate;

	// TOD0-03: Update code below to use TestRestTemplate (as opposed to RestTemplate)
	...
	// TOD0-04: Modify the code below so that it handles 404 HTTP response status
	...
	// TOD0-05: Observe a log message in the console indicating
