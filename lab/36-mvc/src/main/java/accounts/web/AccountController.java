 ...
 *
 */
// TOD0-03: Add an appropriate annotation to make this class a REST controller
...
public class AccountController {
	 ...
	 */
	// TOD0-04: Add an appropriate annotation to make this method handle "/accounts"

    @GetMapping("/accounts")
	public List<Account> accountList() {

		// TOD0-05: Implement the logic to find and return all accounts
		...
		// TOD0-06: (If you are using STS) We are about to make lots of
		//          changes, so stop the application otherwise Devtools
		//          will keep restarting it.
	}

	// TOD0-08: Implement the /accounts/{entityId} request handling method.
	...
	// TOD0-10b: If AccountControllerTests.testHandleDetailsRequest()
	//  fails, fix errors before moving on

	// TOD0-11: Run the application
