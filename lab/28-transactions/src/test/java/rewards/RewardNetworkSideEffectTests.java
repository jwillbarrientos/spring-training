 ...
 *
 * TOD0-08: MAKE SURE to revert the propagation attribute back to
 * REQUIRED in RewardNetworkImpl.
 *
 * TOD0-09: Examine the @Test logic below. Note that committed results from the
 ...
 *
 * TOD0-10: Add @Transactional on the class and re-run the test. It should pass.
 * Do you know why?
 */
